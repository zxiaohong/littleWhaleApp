...
//  获取房间类表
  _getList(String houseId) async {
    ...
    // response = await dio.post("http://localhost:9090/getRoomsByHouse", data: {"house_id": houseId});
    // print(response.data);
    // print(response.statusCode);
    var httpClient = new HttpClient();
    String uri = "http://localhost:9090/getRoomsByHouse";
    var result;
